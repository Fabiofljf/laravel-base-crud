                ...
                <div class="col">
                    <form action="{{route('comic.store')}}" method="post">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-xs-8">
                                <input type="text" class="form-control @error('price') is_invalid @enderror" name="price" id="inputName" placeholder="10.00" value="{{old('price')}}">
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-xs-8">
                                <input type="text" class="form-control @error('series') is_invalid @enderror" name="series" id="inputName" placeholder="Batman" value="{{old('series')}}">
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-xs-8">
                                <input type="text" class="form-control @error('sale_date') is_invalid @enderror" name="sale_date" id="inputName" placeholder="2022/01/01" value="{{old('sale_date')}}">
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-xs-8">
                                <input type="text" class="form-control @error('type') is_invalid @enderror" name="type" id="inputName" placeholder="Comic book" value="{{old('type')}}">
                            </div>
